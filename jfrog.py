...
def jfrogUpload() :
    ...
    url = 'http://100.25.177.3:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/java-3.0/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
    password = 'Mahi@3698' #replace 'your password with ur actual password'
